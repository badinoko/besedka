...
**Версия:** 3.0 - Очищенная и финализированная (июнь 2025)  
...
## 🔧 3. ПРОЦЕДУРЫ И СКРИПТЫ ДЛЯ АУДИТА

### 3.1. **Скрипт очистки временных пользователей**
Выполняется для удаления всех `temp_` пользователей из БД.
```python
from users.models import User
# ... (код скрипта из файла) ...
```

### 3.2. **Скрипт для проверки состояния пользователей**
Выводит отчет о всех пользователях, их ролях и email.
```python
from users.models import User
# ... (код скрипта из файла) ...
```
...
## 🚀 4. БЫСТРЫЙ ДОСТУП ДЛЯ ТЕСТИРОВАНИЯ

### 4.1. 🔑 **Унифицированные учетные данные:**
```

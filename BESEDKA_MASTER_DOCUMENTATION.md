...
**Версия:** 11.0 - Гармонизация SSOT (июнь 2025)
...
- **Унифицированные списки:** Большинство списковых страниц (новости, галерея, гроу-репорты) работают на `UnifiedListView` и используют единые шаблоны `base_list_page.html` и `_unified_cards_wrapper.html`.
...
- **Управляемые отклонения:** В проекте предусмотрена возможность осознанных отклонений от стандартных компонентов для решения уникальных задач (например, страница уведомлений).

**Подробности реализации и правила отклонений:** См. **[BESEDKA_UI_STANDARDS.md](BESEDKA_UI_STANDARDS.md)**
...
### **ЭТАП 1: SSOT-унификация и гармонизация** (ЗАВЕРШЕНО — 15.06.2025)
...
- **✅ ГАРМОНИЗИРОВАНА:** Вся ключевая документация проекта
- **✅ ВЕРСИЯ 11.1:** Выделена главная страница, навигация закреплена (fixed-top), обновлены стандарты UI/UX
